...
export interface ExternalItemReflectionView {
  id: string;
...
interface ExternalItemReflectionCardProps {
  reflection: ExternalItemReflectionView;
  isEditing?: boolean;
  isSaving?: boolean;
  isDeleting?: boolean;
...
export function ExternalItemReflectionCard({
  reflection,
  isEditing = false,
  isSaving = false,
  isDeleting = false,
  ...
  onToggleVisibility,
  onContentChange,
}: ExternalItemReflectionCardProps) {
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={6}
              placeholder="Keep a private reflection for this saved item."
